...
<img src="assets/banner.png" alt="Lucas Green Book" width="820">
...
[![Data](https://img.shields.io/badge/data-OpenStreetMap_+_USGS_3DEP-b8860b?style=flat-square)](#-how-its-made--open-data-only)
![Not for sale](https://img.shields.io/badge/not_for_sale-free_forever-2b6a2b?style=flat-square)
![Rule 4.3](https://img.shields.io/badge/designed_for-Rule_4.3-555?style=flat-square)

**[🌐 Website](https://lucasgreenbook.org)** &nbsp;·&nbsp; [⛳ What it is](#-what-it-is) &nbsp;·&nbsp; [🛰️ How it's made](#-how-its-made--open-data-only) &nbsp;·&nbsp; [🔧 Pipeline](#-pipeline-overview) &nbsp;·&nbsp; [⚖️ License](#-license)
...
## 🛰️ How it's made — open data only
...
- **Not included:** the `courses/` folder — per‑course data (OSM/LiDAR caches) and the generated
  books are kept **local**, not in version control.
...
## ⚖️ License
**Free for personal, non‑commercial use — not for commercial use.**
