...
### ✅ All TWELVE distributed books are CLEAN
...
Poppy Ridge *(yardage-mode — no green maps)* · The Reserve at Spanos Park · Valley Hi.

*(This heading said "ELEVEN" while listing only six. The authoritative machine-generated list,
regenerated by `tools/gen_provenance.py`, is `03_PROVENANCE_BY_COURSE.md` — prefer it over this
hand-maintained summary if they ever disagree.)*
